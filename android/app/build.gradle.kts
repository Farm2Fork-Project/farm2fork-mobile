...
// Google Maps API key: never committed. Read from android/local.properties
// (MAPS_API_KEY=...) or the MAPS_API_KEY environment variable (CI).
...
android {
    ...
    defaultConfig {
        ...
        // google_maps_flutter requires API 24+.
